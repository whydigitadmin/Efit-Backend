...
public interface SubContractInvoiceRepo extends JpaRepository<SubContractInvoiceVO, Long> {
	...
	@Query(nativeQuery = true, value = "select a.jobworkorderno,a.jobworkorderdate,a.dcno,a.pono,a.routecardno,a.contractorname,a.contractorcode,a.destination from t_jobworkout a where \r\n"
			+ "a.orgid=?1 and a.active=1 order by a.jobworkorderno")
	Set<Object[]> getJobWorkOutOrderNo(Long orgId);

	@Query(nativeQuery = true, value = "select a.part,a.partdesc,a.process,a.rate,a.sgst,a.cgst,a.discount,a.netamount,a.grossamt,a1.amtinwords from\r\n"
			+ "	   t_jobworkout a1,t_jobworkoutdetails a where a1.orgid=?1 and a1.jobworkorderno=?2 and a.jobworkoutid=a1.jobworkoutid and a1.active=true  group by\r\n"
			+ "	   a.part,a.partdesc,a.process,a.rate,a.sgst,a.cgst,a.discount,a.netamount,a.grossamt,a1.amtinwords order by a.part")
