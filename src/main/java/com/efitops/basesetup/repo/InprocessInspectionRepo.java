...
public interface InprocessInspectionRepo extends JpaRepository<InprocessInspectionVO, Long> {
	...
	@Query(nativeQuery = true, value = "select a.docid,a.wono,a.fgpartname,fgpartdesc,a.customername from t_routecardentry a where \r\n"
	...
	@Query(nativeQuery = true, value = "select a.drawingno from m_drawingmaster a where a.orgid=?1 and a.fgpartno=?2 and \r\n"
