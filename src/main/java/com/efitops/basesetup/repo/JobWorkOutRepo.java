...
public interface JobWorkOutRepo extends JpaRepository<JobWorkOutVO, Long>{
	...
	@Query(nativeQuery = true, value = "select * from  jobworkout  where orgid=?1")
	...
	@Query(nativeQuery = true, value ="SELECT customername,customeraddress,dcno,gstno,routecardno,scissueno,subcontractorid,subcontractorname,subcontractoraddress,vehicleno FROM efit_ops.dcforsubcontract\r\n"
