...
public interface QuotationRepo extends JpaRepository<QuotationVO, Long> {
	...
	@Query(nativeQuery = true, value = "  select a.docid,a.docdate,a.contactname,a.contactno from enquiry a where\r\n"
	...
	@Query(nativeQuery = true, value = "select a.partcode,a.partdescription,a.drawingno,a.revisionno,a.unit,a.requireqty from enquirydetails a,enquiry a1 where a1.enquiryid=a.enquiryid and\r\n"
