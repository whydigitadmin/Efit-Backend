...
public interface QuotationRepo extends JpaRepository<QuotationVO, Long> {
	...
	@Query(nativeQuery = true, value = "  select a.docid,a.docdate,a.contactname,a.contactno from t_enquiry a where\r\n"
			+ "     a.orgid=?1 and a.customercode=?2 and active=true group by a.docid,a.docdate,a.contactname,a.contactno order by a.docid")
	...
	@Query(nativeQuery = true, value = "select a.partcode,a.partdescription,a.drawingno,a.revisionno,a.unit,a.requireqty from t_enquirydetails a,t_enquiry a1 where a1.enquiryid=a.enquiryid and\r\n"
			+ "		       a1.orgid=?1 and a1.docid=?2 and a1.customercode=?3 and  active =1 group by \r\n"
			+ "					a.partcode,a.partdescription,a.drawingno,a.revisionno,a.unit,a.requireqty  order by  a.partcode")
