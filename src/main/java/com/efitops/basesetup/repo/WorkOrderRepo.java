...
public interface WorkOrderRepo extends JpaRepository<WorkOrderVO, Long> {
	...
	@Query(nativeQuery = true, value = "select * from workorder  where  orgid=?1")
	...
	@Query(nativeQuery = true, value = "select a.docid,a.productionmanager from quotation a where a.orgid=?1 and\r\n"
