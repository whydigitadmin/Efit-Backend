...
public interface IncomingMaterialInspectionRepo extends JpaRepository<IncomingMaterialInspectionVO, Long> {
	...
	@Query(nativeQuery = true,value = "select  a.grnno,a.pono,a.suppliername,a.invdcno,b.acceptqty from t_grn a,t_grndetails b where a.orgid=?1 and a.grnno=?2 and a.active = 1 and \r\n"
	...
	@Query(nativeQuery = true,value = "select a1.itemcode,a1.itemdesc from t_grn a,t_grndetails a1 where a.orgid=?1 and \r\n"
