...
public interface EnquiryRepo extends JpaRepository<EnquiryVO, Long> {
	...
	@Query(nativeQuery = true, value = "select a.itemname,a.itemdesc,a.primaryunit from item a where a.orgid=?1 and a.itemtype in('FG','SFG') and  active=1 and cancel=0 group by\r\n"
